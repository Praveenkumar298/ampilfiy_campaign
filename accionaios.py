...
campaign_data = {
   ...
   'app_name' : 'ACCIONA%20Mobility',
   'bundle_name' : 'ACCIONA Mobility',
   'app_id' : '1431664935',
   'app_version_code' : '11063', #11062
   'app_version_name' : '1.40.0', #1.39.1
   'supported_os' : '13',
   'platformextension' : 'ios_reactnative',
   'ref' : 'db7329eef4753e02f2f61ae54182f260365b4da62dc7cab86fc41cde012bd3f8;0;0;0;0;0',
    'appsflyer' : { 
      'key' : 'zRKSYuq9DAnVgh3mQ8ACm',
      'server_api_version' : '6.8',
      'buildnumber' : '6.8.1',
      'version' : 'v6.8',
      'spi_key' : 'DQjkjNzd3y66hDao8l99pnaIy+jJCv5S30FZuqfDJem5JMI2G3cPBLQFtaLFKPRX',
    #   'spi_key' : 'OcpWnjMBmZvFNP4niOsCclQrwHlR4lFZ2YX7txaG9tq7w4cpev4xQ1YwCD8zFMhy',#devkey
    },
...
firebase_data = {"run": true, "X-Android-Cert": "AIzaSyDikn0GN6m6lKP27GWxlU9N5Z2tB-MkZBk", "data": {"appId": "1:478688264779:ios:a1696dd6d5722236", "fid": "eqzUDepHDkfGmLQLUG1xG2", "authVersion": "FIS_v2", "sdkVersion": "i:8.14.0"}, "agent": "ACCIONA%20Mobility/11062 CFNetwork/1220.1 Darwin/20.3.0", "url": "/v1/projects/motit-motosharing/installations/"}
#=======================conversion===================================
...
def appsflyer_gcdsdk(app_data, device_data):
    url = 'https://gcdsdk.appsflyersdk.com/install_data/v5.0/id' + campaign_data.get('app_id')
    httpmethod = 'get'
    headers = {
        'Accept': '*/*',
