...
campaign_data = {
   ...
   'ref' : 'db7329eef4753e02f2f61ae54182f260365b4da62dc7cab86fc41cde012bd3f8;0;0;0;0;0',
    'appsflyer' : { 
      ...
      'buildnumber' : '6.8.1',
      'version' : 'v6.8',
      'spi_key' : 'OAmCUvCW3IihdlJaNXhTFyvH5DDo5ve7fNENoQjV2d7v4lTooPB+sb+hCRD29kUu',
    #    'spi_key' : 'oYy/d6RzLGUQi6YYyRqR0VqeALKJ8i5qmkEziVNQi2/hE7wU0AnLo905SiRTkat6',#devkey
    },
...
firebase_data = {"run": true, "X-Android-Cert": "AIzaSyC6Rfjs2hejasn9NOb6FdM6M-c5rAgOmE0", "data": {"appId": "1:661142045570:ios:c1f2b7818b698d8756859b", "fid": "f5ua4xV0aUL0q7Wuw2Q3cD", "authVersion": "FIS_v2", "sdkVersion": "i:8.6.0"}, "agent": "AlicesDreamMergeIsland/22 CFNetwork/1335.0.3.2 Darwin/21.6.0", "url": "/v1/projects/mergeland---alice-s/installations/"}
#=======================conversion===================================
...
def install(app_data, device_data):
    ...
    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "200011", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'characterunlock_2'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'LinearGiftBagView_Open'
    val = {"Event_Activity_ID": "8000"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'LinearGiftBag_Buy_ButtonClick'
    val = {"LinearGiftBag_BagNum": "1", "Event_Activity_ID": "8000", "LinearGiftBag_ID": "34010001"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'LinearGiftBag_Buy_ButtonClick'
    val = {"LinearGiftBag_BagNum": "2", "Event_Activity_ID": "8000", "LinearGiftBag_ID": "34010002"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'LinearGiftBag_Buy_ButtonClick'
    val = {"LinearGiftBag_BagNum": "3", "Event_Activity_ID": "8000", "LinearGiftBag_ID": "34010003"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'CoinSpend_over500'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'CoinSpend_over1000'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "2005", "GiftBag_Type": "1"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "50030103", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "400002", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'LinearGiftBagView_Open'
    val = {"Event_Activity_ID": "8002"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'LinearGiftBag_Buy_ButtonClick'
    val = {"LinearGiftBag_BagNum": "1", "Event_Activity_ID": "8002", "LinearGiftBag_ID": "34010201"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'LinearGiftBag_Buy_ButtonClick'
    val = {"LinearGiftBag_BagNum": "2", "Event_Activity_ID": "8002", "LinearGiftBag_ID": "34010202"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'LinearGiftBag_Buy_ButtonClick'
    val = {"LinearGiftBag_BagNum": "3", "Event_Activity_ID": "8002", "LinearGiftBag_ID": "34010203"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "6005", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'GiftBag_Buy'
    val = {"GiftBag_ID": "6005", "Buy_Success": "2", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "210003", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "3005", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "2014", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'Recharge_Open'
    val = {"payChannel": "1", "Recharge_ID": "20014", "Recharge_Type": "3"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'GiftBag_Buy'
    val = {"GiftBag_ID": "2014", "Buy_Success": "2", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "2016", "GiftBag_Type": "1"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'GiftBag_Open'
    val = {"GiftBag_ID": "2008", "GiftBag_Type": "2"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'max_ilrd'
    val = {"adunit_id": "f70b9f4a7a01ed44", "adunit_format": "REWARD", "af_revenue": "0.03", "network_placement": "ca-app-pub-4397646083813223/9153106996", "network_placement_id": "", "country": "IN", "publisher_revenue": "0.03", "network_name": "Google AdMob"}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
