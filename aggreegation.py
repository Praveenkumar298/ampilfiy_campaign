...
null = None
campaign_data = {
   'package_name' : 'com.game.aggregation.carousel',
   'app_name' : 'Carousel Casual Games',
   'app_version_name' : '1.1.99_ww',
...
firebase_data = {"url": "/v1/projects/carousel-b4d88/installations", "x-firebase-client":"H4sIAAAAAAAAAKtWykhNLCpJSk0sKVayio7VUSpLLSrOzM9TslIyUqoFAFyivEQfAAAA", "X-Android-Cert": "4B3E1DA18BC3A498E3E3DD210FD23F857B64E760", "x-goog-api-key": "AIzaSyBDUsiM5K7IwNNzDNJdf0ZJBdDyeR18S0o", "data": {"fid": "erUKySQrRZuxL2TTIYbBpe", "appId": "1:1027387896765:android:0bf96e47d5e1bd91c218d4", "authVersion": "FIS_v2", "sdkVersion":"a:17.1.4"}}
#================================ Adjust Session ================================
def adjust_session( app_data, device_data):
    ...
    data = {
        ...
        'google_app_set_id':app_data.get('gdid'),
        'gps_adid_attempt':  ' 1',
