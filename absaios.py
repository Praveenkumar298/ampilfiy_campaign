...
null = None
campaign_data = {
   'package_name' : 'za.co.absa.absabanking',
   'app_name' : 'Absa%20Banking',
   'bundle_name' : 'Absa Banking',
   'app_id' : '1085620596',
   'app_version_code' : '1',
   'app_version_name' : '7.19.0',
   'supported_os' : '14',
   'platformextension' : 'ios_adobe_ex',
   'ref' : 'db7329eef4753e02f2f61ae54182f260365b4da62dc7cab86fc41cde012bd3f8;0;0;0;0;0',
    'appsflyer' : { 
      'key' : 'H7p9iqppZJVkwjBCcP7CAD',
      'server_api_version' : '6.2',
      'buildnumber' : '6.2.6',
      'version' : 'v6.2',
      'spi_key' : 'aBu34vy1IcELCEbeuQ1znD6KBTp+vokQeevWqlEXOvlGCrAUNpM628Ulv91lODzL',
       #'spi_key' : 'agVQdFn4hIZjokJ30RVtbvU7j4ZTLY7G1D1OCb1HHZ2xG9geNYGYoOOE94rgl2O8',#devkey
    },
...
firebase_data = {"run": true, "X-Android-Cert": "AIzaSyDm1Q-ZtqPGbFUEsEp_E0_pHGrrBB42qYs", "data": {"appId": "1:603468065286:ios:39a6816ba0aa3932", "fid": "fVgh7z4z1EdogwrbFI0aiH", "authVersion": "FIS_v2", "sdkVersion": "i:1.5.0"}, "agent": "Absa%20Banking/1 CFNetwork/1335.0.3.2 Darwin/21.6.0", "url": "/v1/projects/absa-banking-app-a5abb/installations/"}
#=======================conversion===================================
...
def install(app_data, device_data):
    ...
    name = 'NTB_WelcomeToAbsaScreen_ScreenDisplayed'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_WelcomeToAbsaScreen_OpenAnAccountButtonClicked'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'NTB_WelcomeToAbsaScreen_RegisterForDigitalBankingButtonClicked'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'Registration ATM And PIN Screen'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
    ...
    name = 'NTB_GetStartedScreen_ScreenDisplayed'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_GetStartedScreen_LetsDoThisButtonClicked'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_ChooseYourAccountScreen_ScreenDisplayed'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_ChooseYourAccountScreen_PersonalAccountButtonRadioButtonSelected'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_ChooseYourAccountScreen_NextButtonClicked'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_WhereYouAreScreen_ScreenDisplayed'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_ServiceErrorScreen_ScreenDisplayed'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)


    name = 'NTB_ServiceErrorScreen_DoneButtonClicked'
    val = {}
    req = appsflyer_inapps(app_data, device_data, event__Name = name, event__Value = val)
    util.execute_request(**req)
