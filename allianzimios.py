...
campaign_data = {
    'package_name'       :'com.allianztr.myallianz',
    'app_size'           : 50,
    'app_name'           :'oneapp',
    'app_version_name'   : '6.11.2',
    'app_version_code'   : '2',
    'app_id'             : '1066403249',
...
def install(app_data, device_data):
    ...
    # req= adjust_event(campaign_data, app_data, device_data,event_token='2psh1m',t1=10,t2=20,)
