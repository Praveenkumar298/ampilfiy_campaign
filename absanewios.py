...
campaign_data = {
   ...
   'ref' : 'db7329eef4753e02f2f61ae54182f260365b4da62dc7cab86fc41cde012bd3f8;0;0;0;0;0',
    'appsflyer' : { 
      ...
      'buildnumber' : '6.2.6',
      'version' : 'v6.2',
      'spi_key' : 'MtuhbYJTGYSeoFi6Y91U0TFgtBjhHORyWhW5xrkYydJw57xINDhZ4/Lm2LSqvEtB',
    #    'spi_key' : 'R/POel+JOwLDavxakr5nF+5UVMfgvsRwl9eljmBP3r5Fj6GwgKy6r3GN5LX5w3sr',#devkey
    },
...
firebase_data = {"run": true, "X-Android-Cert": "AIzaSyDm1Q-ZtqPGbFUEsEp_E0_pHGrrBB42qYs", "data": {"appId": "1:603468065286:ios:39a6816ba0aa3932", "fid": "e8QLoQFvdknapVulK7iGuj", "authVersion": "FIS_v2", "sdkVersion": "i:1.5.0"}, "agent": "Absa%20Banking/1 CFNetwork/1335.0.3.4 Darwin/21.6.0", "url": "/v1/projects/absa-banking-app-a5abb/installations/"}
#=======================conversion===================================
