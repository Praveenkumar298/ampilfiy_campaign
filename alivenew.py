...
campaign_data = {
   ...
   'app_size' : 38,
   'adjust' : { 
      'sdk' : 'react-native4.33.0@android4.33.2',
...
firebase_data = {"url": "/v1/projects/hma-project-28eee/installations/dU1lDZC8TaOsDxCfKVNPAo/authTokens:generate", "x-firebase-client": "H4sIAAAAAAAAAKtWykhNLCpJSk0sKVayio7VUSpLLSrOzM9TslIyUqoFAFyivEQfAAAA", "X-Android-Cert": "AC178BAB98A48D01A5993B56A329E8B2C0E8B8BD", "x-goog-api-key": "AIzaSyDWxggwtgirMAC3VjQhaMsUevJ9qHMP790", "data": {"installation": {"sdkVersion": "a:17.0.1"}}}
#================================ Adjust Session ================================
...
def install(app_data, device_data):
    ...
    req = adjust_sdk_click( app_data, device_data,source='deeplink')
    util.execute_request(**req)
    time.sleep(random.randint(1,5))
    # print 'Attribution'
